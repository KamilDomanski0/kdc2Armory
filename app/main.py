...
SORTABLE_FIELDS = {
    ...
    "stab_damage": Item.stab_damage,
    "slash_damage": Item.slash_damage,
    "blunt_damage": Item.blunt_damage,
    "weapon_defense": Item.weapon_defense,
    "durability": Item.durability,
    "reach": Item.reach,
    "weapon_speed": Item.weapon_speed,
    "weight": Item.weight,
    "strength_requirement": Item.strength_requirement,
    "agility_requirement": Item.agility_requirement,
